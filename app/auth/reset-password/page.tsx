...
export default function ResetPasswordPage(){return <Suspense fallback={<main className="min-h-screen bg-[#06150d] text-white flex items-center justify-center">Loading secure password setup…</main>}><ResetPasswordForm/></Suspense>}
