  ...
  return <main className="min-h-screen bg-[#06150d] px-4 py-10 text-white flex items-center justify-center">
    <section className="w-full max-w-md rounded-[2rem] border border-white/10 bg-black/35 p-7 sm:p-9 shadow-2xl backdrop-blur-xl">
      ...
      <form onSubmit={submit} className="mt-7 space-y-4">
        ...
        <label className="block text-sm">Email<input required type="email" value={email} onChange={e=>setEmail(e.target.value)} autoComplete="email" className="mt-2 w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 outline-none"/></label>
